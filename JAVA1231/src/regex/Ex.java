...
public class Ex {
	...
	public static void main(String[] args) {
		...
		if(Pattern.matches(phoneRegex, phone)) {
			System.out.println(phone + " - 정상적인 번호 형식 입니다.");
		} else {
			System.out.println(phone + " - 잘못된 번호 형식 입니다.");
		}
	}
